...
for j in range(outputnumber1,outputnumber2+1):
    ...
    if tarmantlecolor == "cmap":
        scatter=ax.scatter(xtarmant,ytarmant,ztarmant,c=tarmantvalue,norm=norm,cmap=colormap,marker='.',s=particlesize,depthshade=False)
    else:
        ax.scatter(xtarmant,ytarmant,ztarmant,c=tarmantlecolor,marker='.',s=particlesize,depthshade=False)

    if tarcorecolor == "cmap":
        scatter=ax.scatter(xtarcore,ytarcore,ztarcore,c=tarcorevalue,cmap=colormap,norm=norm,marker='.',s=particlesize,depthshade=False)
    else:
        ax.scatter(xtarcore,ytarcore,ztarcore,c=tarcorecolor,marker='.',s=particlesize,depthshade=False)

    if impmantlecolor == "cmap":
        scatter=ax.scatter(ximpmant,yimpmant,zimpmant,c=impmantvalue,cmap=colormap,norm=norm,marker='.',s=particlesize,depthshade=False)
    else:
        ax.scatter(ximpmant,yimpmant,zimpmant,c=impmantlecolor,marker='.',s=particlesize,depthshade=False)
    
    if impcorecolor == "cmap":
        scatter=ax.scatter(ximpcore,yimpcore,zimpcore,c=impcorevalue,cmap=colormap,norm=norm,marker='.',s=particlesize,depthshade=False)
    else:
        ax.scatter(ximpcore,yimpcore,zimpcore,c=impcorecolor,marker='.',s=particlesize,depthshade=False)
