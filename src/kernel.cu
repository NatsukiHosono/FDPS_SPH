...
namespace DENS{
	...
	int DispatchKernelDynamicAllocate(const PS::S32 tag, const int n_walk, const STD::EPI::Dens* epi[], const int* n_epi, const STD::EPJ::Dens* epj[], const int* n_epj){
	...
	int RetrieveKernelDynamicAllocate(const PS::S32 tag, const PS::S32 n_walk, const PS::S32* ni, STD::RESULT::Dens* force[]){
		int ni_tot = 0;
