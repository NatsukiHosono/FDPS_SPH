...
namespace EoS {
    ...
    public:
        Tillotson(const type a_rho0, const type a_u0, const type a_uiv, const type a_ucv, const type a_A,
                  const type a_B, const type a_a, const type a_b, const type a_alpha, const type a_beta,
...
static const EoS::ANEOS<PS::F64> Iron("eos/ironS2.rho_u.txt");
